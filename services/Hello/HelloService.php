...
class HelloServiceClient implements \services\Hello\HelloServiceIf {
  ...
  {
    $args = new \services\Hello\HelloService_sayHello_args();
  ...
  public function recv_sayHello()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\services\Hello\HelloService_sayHello_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \services\Hello\HelloService_sayHello_result();
...
class HelloServiceProcessor {
  ...
  protected function process_sayHello($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\services\Hello\HelloService_sayHello_args', $input->isStrictRead());
    }
    else
    {
      $args = new \services\Hello\HelloService_sayHello_args();
